        ...
        <div className='grid w-[80%] mx-auto grid-cols-1 lg:grid-cols-7 gap-[30px] items-center'>
            ...
            <div className='col-span-4'>
                <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-3 xl:grid-cols-4 gap-[20px] items-center'>
                    ...
                    <div data-aos="flip-left" data-aos-anchor-placement="top-center" data-aous-delay="200">
                        <SkillCard title="CSS" image='./images/css.svg' percent="97%"/>
                    </div>

                    <div data-aos="flip-left" data-aos-anchor-placement="top-center" data-aous-delay="400">
                        <SkillCard title="Tailwind" image='./images/tailwind.svg' percent="80%"/>
                    </div>

                    <div data-aos="flip-left" data-aos-anchor-placement="top-center" data-aous-delay="600">
                        <SkillCard title="JavaScript" image='./images/js.svg' percent="80%"/>
                    </div>

                    <div data-aos="flip-left" data-aos-anchor-placement="top-center" data-aous-delay="800">
                        <SkillCard title="React" image='./images/react.svg' percent="90%"/>
                    </div>

                    <div data-aos="flip-left" data-aos-anchor-placement="top-center" data-aous-delay="1000">
                    ...
                    <div data-aos="flip-left" data-aos-anchor-placement="top-center" data-aous-delay="1200">
