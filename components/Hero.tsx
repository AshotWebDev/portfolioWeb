...
const Hero = () => {
    ...
    return (
        <div id='home' className='w-[100vw] pt-[7vh] md:pt-[12vh] h-[1030px] lg:h-[100vh] custom-bg' style={{ backgroundImage: `linear-gradient(to right,rgba(0, 0, 0, 0.836),rgba(0, 0, 0, 0.811)),url('/images/bg.jpg')` }}>
